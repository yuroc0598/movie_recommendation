...
public class Profile
{
	...
	public void getwhole(){
		...
		double	r_value=r.doubleValue();
		System.out.println("here in profile getWhole function, print the values in map=>"+r_value);
			}
	...
	public double getMeanValue()
	{
		...
		for(Double r: dataMap.values()){
			total += r.doubleValue();
		//yurong
		//System.out.println("here in profile getMeanValue function, print the values in map=>"+r.doubleValue());
			}
